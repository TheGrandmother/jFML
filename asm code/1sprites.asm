...
#sprites.UpdateCordinates
	...
	MOV $sprites.UpdateCordinates.temp_x $sprites.x_table

	//DIV $sprites.UpdateCordinates.temp_z 2
	//ADD s $sprites.UpdateCordinates.temp_y
	MOV $sprites.UpdateCordinates.temp_y $sprites.y_table
	...
	//DIV $sprites.UpdateCordinates.temp_z 2
	//ADD s $sprites.UpdateCordinates.temp_x
	MOV $sprites.UpdateCordinates.temp_x x
	ADD sprites.x_table 1
	MOV x $s

	//DIV $sprites.UpdateCordinates.temp_z 2
	//ADD s $sprites.UpdateCordinates.temp_y
	MOV $sprites.UpdateCordinates.temp_y x
	ADD sprites.y_table 1
	MOV x $s
